...
namespace ConsoleGUI.Inputs
{
    public class TextArea : Input
    {
        ...
        public TextArea(Window parentWindow, int x, int y, int width, int height, string iD) : base(parentWindow, x, y, width, height, iD)
        {
            Selectable = true;
        }
        ...
        public override void Draw()
        {
            ...
            for (int i = Offset; i < Height + Offset; i++)
            {
                ...
                WindowManager.WriteText(ref WindowBuffer, line, new() { startY = i - Offset, textColor = TextColour, backgroundColor = BackgroundColour });
            }
            ...
            WindowManager.WriteText(ref WindowBuffer, "■", new() { startX = Width - 1, startY = postion, textColor = ConsoleColor.DarkGray, backgroundColor = ConsoleColor.White });
        }
